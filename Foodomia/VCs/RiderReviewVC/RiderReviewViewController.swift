//
//  RiderReviewViewController.swift
//  Foodomia
//
//  Created by Rao Mudassar on 2/2/18.
...
class RiderReviewViewController: UIViewController,UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        rest_name.text = UserDefaults.standard.string(forKey:"notiRiderName")!
       
        rest_img.sd_setImage(with: URL(string:"abc"), placeholderImage: UIImage(named: "Unknown"))
    ...
    @IBAction func Done(_ sender: Any) {
        ...
        UserDefaults.standard.set("No", forKey:"RiderReview")
...
DispatchQueue.main.asyncAfter(deadline: .now()+1) {
   KRProgressHUD.dismiss()
        ...
        let url : String = appDelegate.baseUrl+appDelegate.giveRatingsToRider
        let headers: HTTPHeaders = [
            "api-key": "2a5588cf-4cf3-4f1c-9548-cc1db4b54ae3"
            
        ]
    
        let parameter :[String:Any]? = ["user_id":UserDefaults.standard.string(forKey: "uid")!,"rider_user_id":UserDefaults.standard.string(forKey: "notiRider")!,"comment":txt_review.text,"star":String(count),"order_id":UserDefaults.standard.string(forKey:"notiRiderOrderID")!]
        //print(url)
        print(parameter!)
