...
class SelectAddressPresent: UIViewController,UITableViewDataSource,UITableViewDelegate {
...
DispatchQueue.main.asyncAfter(deadline: .now()+1) {
   KRProgressHUD.dismiss()
        ...
        let parameter :[String:Any]? = ["user_id":UserDefaults.standard.string(forKey: "uid")!,"sub_total":sub_total,"restaurant_id":restaurant_id]
        print(url)
        print(parameter!)
            ...
            case .success( let value):
                ...
                if(String(describing: code) == "200"){
                    ...
                    for Dict in myCountry! {
                        let myAddress = Dict["Address"] as! NSDictionary
                        ...
                        let delivery_fee = myAddress["delivery_fee"]
                        let total_amount = myAddress["total_amount"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(indexPath.row == self.AddressList.count){
            ...
            let LoginVC:AddAddressPresent =  (storyboard!.instantiateViewController(withIdentifier: "AddAddressPresent") as? AddAddressPresent)!
