...
class AddAdressViewController: UIViewController,GMSMapViewDelegate,CLLocationManagerDelegate {
    ...
    @IBOutlet weak var brn_save: UIBarButtonItem!
    ...
    override func viewDidLoad() {
        ...
        brn_save.setTitleTextAttributes([NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): font!], for: .normal)
