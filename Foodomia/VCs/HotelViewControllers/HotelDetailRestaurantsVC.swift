//
//  HotelDetailRestaurantsVC.swift
//  Foodomia
//
...
class HotelDetailRestaurantsVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if(StaticData.singleton.isRESDetail == "yes"){
...
DispatchQueue.main.asyncAfter(deadline: .now()+1) {
   KRProgressHUD.dismiss()
    ...
    @IBAction func Acceptbtn(_ sender: Any) {
        StaticData.singleton.isReason = "Accept"
        self.performSegue(withIdentifier:"declineto", sender:self)
        
        
    }
    
    @IBAction func DeclineBtn(_ sender: Any) {
         StaticData.singleton.isReason = "Decline"
        self.performSegue(withIdentifier:"declineto", sender:self)
    }
...
DispatchQueue.main.asyncAfter(deadline: .now()+1) {
   KRProgressHUD.dismiss()
        ...
        let parameter :[String:Any]? = ["order_id":StaticData.singleton.OrderId!,"status":"1","time":result]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if(indexPath.section == notificaionArray.count){
                ...
                cell.total_name.text = StaticData.singleton.historySymbol!+StaticData.singleton.OrderServiceFee!
               // self.val = Float((self.val/100)*self.tottal)
                ...
                //cell.txt_fee.text = StaticData.singleton.historySymbol!+String(format: "%.2f",Float(self.val))
                ...
                cell.txt_tax.text = StaticData.singleton.historySymbol!+String(format: "%.2f",Float(self.tottal))
...
//                    cell.image_lbl.alpha = 0
    ...
    @IBAction func call(_ sender: Any) {
        ...
        if let phoneCallURL = URL(string: "tel://"+StaticData.singleton.OrderUserPhone!) {
