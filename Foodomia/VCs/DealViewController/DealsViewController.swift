...
//  Foodomia
//
//  Created by Rao Mudassar on 11/24/17.
...
DispatchQueue.main.asyncAfter(deadline: .now()+1) {
   KRProgressHUD.dismiss()
        ...
        let url : String = appDelegate.baseUrl+appDelegate.showDeals
        let parameter :[String:Any]? = ["lat":defaults.string(forKey: "hostel_lat")!,"long":defaults.string(forKey: "hostel_lon")!,"current_time":result]
        print(url)
        print(parameter!)
            ...
            case .success( let value):
                ...
                if(String(describing: code) == "200"){
                    ...
                    for Dict in myCountry {
                        ...
                        let Deal_fee = myRestaurant1["delivery_fee"]
...
DispatchQueue.main.asyncAfter(deadline: .now()+1) {
   KRProgressHUD.dismiss()
            ...
            case .success( let value):
                ...
                if(String(describing: code) == "200"){
                    ...
                    for Dict in myCountry {
                        ...
                        let Dealid = myRestaurant["id"]
                        let des_detail = myRestaurant["description"]
                        var myStringArr = (myRestaurant["expire_date"] as! String).components(separatedBy:" ")
                        let expire_date = myStringArr[0]
                        let Dealname = myRestaurant["name"]
                        let Dealprice = myRestaurant["price"]
                        let restaurant_id = myRestaurant["restaurant_id"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier:"dealdetail", sender:self)
